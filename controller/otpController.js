  ...
  try {
    ...
    if (otp != otpVarify.otp) {
      ...
      const user = await User.create({
        firstName: otpVarify.firstName,
        secondName: otpVarify.secondName,
        email: otpVarify.email,
        password: otpVarify.password,
        userReferralCode : otpVarify.userReferralCode
      });
      if (otpVarify.referredId){

...
const {
  ...
  deleteCategoryOffer,
  editCategoryOffer,
} = require("../controller/adminController/categoryListController");
const {
  addProduct,
  adminProductList,
  manageProduct,
...
const {
  ...
  returnProductStatus,
  returnListFilter,
} = require("../controller/adminController/adminOrderManagementController");
const {
  getAddCouponPage,
  addCoupon,
  couponList,
...
const {
  ...
  downloadExcelByDate,
  downloadPDFByDate,
} = require("../controller/adminController/download");
const {
  adminDashboard,
  filterGraph,

...
const placeOrder = async (req, res) => {
  try {
    ...
    if (paymentMethod == "cod" && total > 1000) {
      ...
      throw new Error(
        "Sorry, cash on delivery is not available for orders exceeding $1000. Please choose an alternative payment method during checkout."
      );
    }
